    ...
    return (
        ...
        >
            ...
            <header
                ...
                data-oid="n8q.ldb"
            >
                <div className="container mx-auto px-4 py-4" data-oid="y-9afwm">
                    <div className="flex justify-between items-center" data-oid="5_..ogx">
                        {/* Logo */}
                        <Link href="/" className="flex items-center space-x-2" data-oid="d366e8i">
                            <div className="h-10 w-10 overflow-hidden" data-oid=".wlaz6p">
                                <img
                            ...
                            <span className="text-xl font-bold text-purple-800" data-oid="8s-:u6t">
                                Ryn VPN
                            </span>
                        </Link>

                        {/* Navigation */}
                        <nav className="hidden md:flex space-x-8" data-oid="-ju:r1d">
                            <Link
                                href="/"
            ...
            {/* Hero Section */}
            <section className="py-16 px-4 bg-purple-900 bg-opacity-80" data-oid="zt9fnzg">
                <div className="container mx-auto max-w-6xl text-center" data-oid="4f3zlfm">
                    <h1
                    ...
                    <p className="text-xl text-gray-200 max-w-3xl mx-auto" data-oid="j26-.h9">
            ...
            <section className="py-16 px-4 bg-white" data-oid="75kdtq5">
                <div className="container mx-auto max-w-4xl" data-oid="z2pr1lb">
                    <div className="prose prose-lg max-w-none text-gray-700" data-oid=":r-ctw8">
                        <div className="mb-8 text-center" data-oid="n6_2sz9">
                            <h2
                            ...
                            <p className="text-xl text-purple-700 font-semibold" data-oid="0y1d1lg">
                        ...
                        <p data-oid="z-j.f:1">Ryn VPN collects four types of information:</p>
                        <ul className="list-disc pl-6 mb-6" data-oid="2y:-y-m">
                            <li data-oid="0g6bbiw">
                                <strong data-oid="0h94m6k">
                        ...
                        <ul className="list-disc pl-6 mb-6" data-oid="ti-3-xj">
                            <li data-oid="b5lrqqz">
                            ...
                            <li data-oid="yt.2z0m">To send you updates and announcements.</li>
                            <li data-oid="l9epwjp">
                        ...
                        <ul className="list-disc pl-6 mb-6" data-oid="_q2t-ob">
                            <li data-oid="n-150xd">
                        ...
                        <ul className="list-disc pl-6 mb-6" data-oid="95bsnq5">
                            <li data-oid="w.k:p0d">
                                Diagnostic information about if and how a VPN connection attempt
                                failed.
                            </li>
                            <li data-oid="61961tj">Speed test data.</li>
                            <li data-oid="qhd:nih">
                                ...
                                <ul className="list-disc pl-6 mt-2" data-oid="fggruld">
                                    <li data-oid="r4kqbj0">
                        ...
                        <ul className="list-disc pl-6 mb-6" data-oid="m1hm2i4">
                            <li data-oid="id-_akt">
                                For the purposes of fulfilling our contractual obligations to users,
                                including:
                                <ul className="list-disc pl-6 mt-2" data-oid="t14rkh-">
                                    <li data-oid="iuxwdha">
                                    ...
                                    <li data-oid="q:o0rca">Providing customer support.</li>
                                </ul>
                            </li>
                            <li data-oid="s88kd93">
                                For a legitimate interest associated with the operation of our
                                business, including:
                                <ul className="list-disc pl-6 mt-2" data-oid=":ryhys:">
                                    <li data-oid="32wiwlu">
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg mt-4" data-oid="02:jpk7">
                            <p data-oid="4ikxopj">
                                <strong data-oid="2orbni6">
                                    Human Data Systems Private Limited
                                </strong>
                            </p>
                            <p data-oid="crgjjp7">H NO.-8/9, BASEMENT ROAD-8,</p>
                            <p data-oid="4vtc3su">SARVPRIYA VIHAR NEW DELHI South Delhi DL</p>
                            <p data-oid="desconh">110017 IN</p>
                            <p className="mt-2" data-oid="yg.s6.l">
                                <a
            ...
            <footer
                ...
                data-oid="ukubjh1"
            >
                <div className="container mx-auto max-w-6xl" data-oid="_1z4ovp">
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8" data-oid="4tss0et">
                        <div data-oid="40j4kth">
                            <div className="flex items-center space-x-2 mb-4" data-oid="ib01b_6">
                                <div className="h-10 w-10 overflow-hidden" data-oid="fh-w5oz">
                                    <img
                                        src="/ryn-vpn-logo.png"
                                        alt="Ryn VPN Logo"
                                        className="h-full w-full object-contain"
                            ...
                            <p className="text-gray-600 mb-4" data-oid=":9ca_.z">
                                Secure, fast, and reliable VPN service for all your devices.
                            </p>
                            <div className="flex flex-col gap-3" data-oid="4tk44th">
                                <a
                                    href="https://play.google.com/store/apps/details?id=com.secure.cryptovpn&hl=en_IN"
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        <div data-oid="gsfxetk">
                            ...
                            <ul className="space-y-2" data-oid="xp.ql3y">
                                <li data-oid="-w4rtve">
                                    <a
                                        href="#"
                        ...
                        <div data-oid="fp:td30">
                            ...
                            <ul className="space-y-2" data-oid="5epqnwv">
                                <li data-oid="jb-nkx7">
                                    <a
                                        href="#"
                                        className="text-gray-600 hover:text-purple-700 transition-colors"
                        ...
                        <div data-oid="dni7qhs">
                            ...
                            <div className="text-gray-600 space-y-2" data-oid="uolm0kx">
                                <p data-oid="1jhqml3">Human Data Systems Private Limited,</p>
                                <p data-oid="l.pfa8:">H NO.-8/9, BASEMENT ROAD-8,</p>
                                <p data-oid="snpn7-q">SARVPRIYA VIHAR NEW DELHI South Delhi DL</p>
                                <p data-oid="l5dolj0">110017 IN</p>
                                <p className="pt-2" data-oid="roakrs0">
                                    <a
                                        href="mailto:bugs@rynvpn.com"
                    ...
                    <div
                        ...
                        data-oid="5zxng5v"
                    >
                        <div className="text-gray-600 mb-4 md:mb-0" data-oid="igxhsj0">
                            © 2025 Ryn VPN - All Rights Reserved.
                        </div>
                        <div className="flex space-x-4" data-oid="-m9b73h">
                            <a
                                href="#"
